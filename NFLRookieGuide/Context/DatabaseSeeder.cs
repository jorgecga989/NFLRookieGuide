...
namespace NFLRookieGuide.Context
{
    public class DatabaseSeeder
    {
        ...
        {
            var p1 = new Player { ApiId = "11cad59d-90dd-449c-a839-dddaba4fe16c", Name = "Patrick Mahomes", Stats = 5000, Description = "Quarterback known for his arm strength and playmaking ability.", Photo = "patrick_mahomes.png", Age = 28, Team = teams[15], Position = position[0] };
